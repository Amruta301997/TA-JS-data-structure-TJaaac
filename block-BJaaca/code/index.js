...
//let character2={characterName:"Arya"}
...
character.greet=alert(`I am ${characterName} and my title is ${character.title}`);
...
character.greet=alert(`she is ${characterName} and her title is ${character.title}`);
